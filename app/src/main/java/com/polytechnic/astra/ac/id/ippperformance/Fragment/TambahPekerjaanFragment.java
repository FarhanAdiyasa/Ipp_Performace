...
public class TambahPekerjaanFragment extends Fragment {
    ...
    public static TambahPekerjaanFragment newInstance(String crimeId) {
        Bundle args = new Bundle();
        args.putString("detailId", crimeId);
        TambahPekerjaanFragment fragment = new TambahPekerjaanFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.tambah_pekerjaan, container, false);
        ...
        mDashboardViewModel.getKryFoto().observe(getViewLifecycleOwner(), new Observer<UserModel>() {
            ...
            public void onChanged(UserModel userModel) {
                if (userModel != null) {
                    Glide.with(TambahPekerjaanFragment.this)
